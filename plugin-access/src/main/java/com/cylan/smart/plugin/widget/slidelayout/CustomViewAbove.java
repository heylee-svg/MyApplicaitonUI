...
import com.cylan.smart.plugin.widget.slidelayout.SlidingMenu;
...
public class CustomViewAbove extends ViewGroup {
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        boolean dragCanceled = action == MotionEvent.ACTION_CANCEL || action == MotionEvent.ACTION_UP
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        // Draw the margin drawable-xhdpi if needed.
