...
public class TimePickerBuilder {
    ...
    //Required
    public TimePickerBuilder(Context context, OnTimeSelectListener listener, OnDialogDismissListener listener2) {
        mPickerOptions = new PickerOptions(PickerOptions.TYPE_PICKER_TIME);
        mPickerOptions.context = context;
        mPickerOptions.timeSelectListener = listener;
        mDialogDismissListener=listener2;
    ...
    public TimePickerView build() {
        return new TimePickerView(mPickerOptions,mDialogDismissListener);
    }
}
